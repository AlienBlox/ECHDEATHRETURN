...
// Type: ReturnOfEchdeeath.PandorasCurse
...
{
  public class PandorasCurse : ModItem
  {
    public override string Texture => "Terraria/Images/Item_" + (short) 3457.ToString();

    public override void SetStaticDefaults() => this.DisplayName.Equals((object) "Pandora's Curse");
    ...
    public override bool? UseItem(Terraria.Player player)
    {
      if (player.whoAmI == Main.myPlayer)
      {
        ...
        int num = ModContent.NPCType<Echdeath>();
        if (Main.netMode != 1)
