...
// Type: ReturnOfEchdeeath.MoonLordsCurse
...
{
  public class MoonLordsCurse : ModItem
  {
    public override string Texture => "Terraria/Images/Item_" + (short) 3458.ToString();

    public override void SetStaticDefaults()
    {
      this.DisplayName.Equals((object) "Moon Lord's Curse");
    }
    ...
    {
      return !NPC.AnyNPCs(ModContent.NPCType<CeilingOfMoonLord>());
    }
    ...
    public override bool? UseItem(Terraria.Player player)
    {
      if (player.whoAmI == Main.myPlayer)
      {
        ...
        int num = ModContent.NPCType<CeilingOfMoonLord>();
        if (Main.netMode != 1)
